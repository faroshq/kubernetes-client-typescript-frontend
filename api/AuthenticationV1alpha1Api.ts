...
export class AuthenticationV1alpha1Api {
     ...
     */
    public createSelfSubjectReview(body: models.V1alpha1SelfSubjectReview, dryRun?: string, fieldManager?: string, fieldValidation?: string, pretty?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1alpha1SelfSubjectReview;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/authentication.k8s.io/v1alpha1/selfsubjectreviews';
        ...
        $.ajax(requestOptions).then(
            (data: models.V1alpha1SelfSubjectReview, textStatus: string, jqXHR: JQueryXHR) =>
    ...
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/authentication.k8s.io/v1alpha1/';
