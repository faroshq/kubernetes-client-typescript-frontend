...
export class ApiextensionsV1Api {
     ...
     */
    public createCustomResourceDefinition(body: models.V1CustomResourceDefinition, pretty?: string, dryRun?: string, fieldManager?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     */
    public patchCustomResourceDefinition(name: string, body: object, pretty?: string, dryRun?: string, fieldManager?: string, force?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1CustomResourceDefinition;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}'.replace('{' + 'name' + '}', encodeURIComponent(String(name)));
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public patchCustomResourceDefinitionStatus(name: string, body: object, pretty?: string, dryRun?: string, fieldManager?: string, force?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1CustomResourceDefinition;  },
    { response: JQueryXHR; errorThrown: string }
    > {
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public replaceCustomResourceDefinition(name: string, body: models.V1CustomResourceDefinition, pretty?: string, dryRun?: string, fieldManager?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1CustomResourceDefinition;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}'.replace('{' + 'name' + '}', encodeURIComponent(String(name)));
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public replaceCustomResourceDefinitionStatus(name: string, body: models.V1CustomResourceDefinition, pretty?: string, dryRun?: string, fieldManager?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1CustomResourceDefinition;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}/status'.replace('{' + 'name' + '}', encodeURIComponent(String(name)));
