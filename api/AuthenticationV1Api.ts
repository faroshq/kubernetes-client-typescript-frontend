...
export class AuthenticationV1Api {
     ...
     */
    public createTokenReview(body: models.V1TokenReview, dryRun?: string, fieldManager?: string, fieldValidation?: string, pretty?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
