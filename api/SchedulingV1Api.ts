...
export class SchedulingV1Api {
     ...
     */
    public createPriorityClass(body: models.V1PriorityClass, pretty?: string, dryRun?: string, fieldManager?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public replacePriorityClass(name: string, body: models.V1PriorityClass, pretty?: string, dryRun?: string, fieldManager?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1PriorityClass;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/scheduling.k8s.io/v1/priorityclasses/{name}'.replace('{' + 'name' + '}', encodeURIComponent(String(name)));
