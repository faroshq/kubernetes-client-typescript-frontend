...
export class StorageV1beta1Api {
     ...
     */
    public createNamespacedCSIStorageCapacity(namespace: string, body: models.V1beta1CSIStorageCapacity, pretty?: string, dryRun?: string, fieldManager?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public replaceNamespacedCSIStorageCapacity(name: string, namespace: string, body: models.V1beta1CSIStorageCapacity, pretty?: string, dryRun?: string, fieldManager?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1beta1CSIStorageCapacity;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities/{name}'.replace('{' + 'name' + '}', encodeURIComponent(String(name))).replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
