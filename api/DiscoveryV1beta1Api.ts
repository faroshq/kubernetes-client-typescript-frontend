...
export class DiscoveryV1beta1Api {
     ...
     */
    public createNamespacedEndpointSlice(namespace: string, body: models.V1beta1EndpointSlice, pretty?: string, dryRun?: string, fieldManager?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1beta1EndpointSlice;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices'.replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
        ...
        $.ajax(requestOptions).then(
            (data: models.V1beta1EndpointSlice, textStatus: string, jqXHR: JQueryXHR) =>
    ...
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices/{name}'.replace('{' + 'name' + '}', encodeURIComponent(String(name))).replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
    ...
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/discovery.k8s.io/v1beta1/';
    ...
    { response: JQueryXHR; body: models.V1beta1EndpointSliceList;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/discovery.k8s.io/v1beta1/endpointslices';
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.V1beta1EndpointSliceList, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     */
    public patchNamespacedEndpointSlice(name: string, namespace: string, body: object, pretty?: string, dryRun?: string, fieldManager?: string, force?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1beta1EndpointSlice;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices/{name}'.replace('{' + 'name' + '}', encodeURIComponent(String(name))).replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public replaceNamespacedEndpointSlice(name: string, namespace: string, body: models.V1beta1EndpointSlice, pretty?: string, dryRun?: string, fieldManager?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1beta1EndpointSlice;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices/{name}'.replace('{' + 'name' + '}', encodeURIComponent(String(name))).replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
